...
#ifdef _MSC_VER
#pragma comment(lib, "d3d12.lib") // Added by Tuffy - unresolved external symbol CreateDXGIFactory1
#pragma comment(lib, "dxgi.lib")  // Added by Tuffy - unresolved external symbol CreateDXGIFactory1
